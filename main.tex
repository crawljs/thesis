...
\abstract{\addtocontents{toc}{\vspace{1em}} % Add a gap in the Contents, for aesthetics
  ...
  Crawl.js aims at the practical importance of downloading pages efficiently and at high speed. The architecture is decentralized and workers are organized in groups (regions) which makes Crawl.js locality-aware. Through the event-driven, non-blocking I/O model of Node.js\footnote{http://nodejs.org} the system is resource friendly and efficient. URLs are managed in Redis\footnote{http://redis.io} sets and operations are asynchronous, atomic and able to handle multiple URLs (batch processing). The combination of Node.js and Redis shows promising performance and linear scalability.
...
\input{./Chapters/02related_work} 
\input{./Chapters/03problem_description}
\input{./Chapters/04crawljs} 
\input{./Chapters/05results} 
\input{./Chapters/06future_work} 
